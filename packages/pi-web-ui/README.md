...
Reusable web UI components for building AI chat interfaces powered by [@earendil-works/pi-ai](https://www.npmjs.com/package/@earendil-works/pi-ai) and [@earendil-works/pi-agent-core](https://www.npmjs.com/package/@earendil-works/pi-agent-core).
...
```bash
pnpm add @earendil-works/pi-web-ui @earendil-works/pi-agent-core @earendil-works/pi-ai
```
