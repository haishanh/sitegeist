...
**Core:**
- `packages/pi-web-ui/src/components/Messages.ts` - Message types
- `packages/pi-web-ui/src/components/MessageList.ts` - Rendering
- `packages/pi-web-ui/src/components/message-renderer-registry.ts` - Registration
- `packages/pi-web-ui/src/agent/agent.ts` - Transformation
